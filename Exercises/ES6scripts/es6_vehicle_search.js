...
let findRedCar = vehicles.filter((car) => car.color.indexOf("Red") != -1);
console.log(findRedCar);
console.log('--------------------');

console.log('Which vehicles have registrations that are expired?');
let expiredRegistrations = vehicles.filter((car) => car.registrationExpires.getFullYear() < 2023);
console.log(expiredRegistrations);
console.log('--------------------');

console.log('Which vehicles that hold at least 6 people?');
let capacityGreaterThan6 = vehicles.filter((car) => car.capacity > 6);
console.log(capacityGreaterThan6);
console.log('--------------------');

console.log('Which vehicles have license plates that end with "222"?');
let findPlateNumber = vehicles.filter((car) => car.licenseNo.indexOf("222") != -1);
